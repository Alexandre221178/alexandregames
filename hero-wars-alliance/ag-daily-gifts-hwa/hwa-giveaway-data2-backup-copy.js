...
window.giveawayWinnersData = {
 pt: {
  ...
  en: {
    title: "🚨 EXCLUSIVE GIVEAWAY: ALEXANDRE GAMES COMMUNITY 🚨",
    ...
    para2: "<p><b>📝 HOW TO PARTICIPATE:</b></p>  <ol>        <li>1️⃣ <strong>Join the group</strong> via the link below (if you’re not already there).</li>        <li>2️⃣ <strong>Drop your ID</strong> in the group to validate your entry.</li>        <li>3️⃣ The draw takes place <b>tomorrow night!</b></li>    </ol>",
    ...
    para4: "🎁 THE PRIZES: <ul>        <li>📌 <b>5 WINNERS</b> selected randomly.</li>        <li>📌 Each winner gets <b>5,000 Metacubes</b> + <b>1 Lucky Boxy Avatar</b>.</li>    </ul>",   
