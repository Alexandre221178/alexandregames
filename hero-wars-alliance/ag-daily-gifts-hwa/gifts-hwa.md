...
// ── Hub gft valid 24HS ──────────────────────────────
  { date:'2026-##-##', type:'hub', code:'##CAIXA-ALTA##', note:'hub24h',
    rewards:['large-skin-stone-chest x5', 'energy x1000'] },

// ── Hub gft valid data not defined ──────────────────────────────
{ date:'2026-##-##', type:'hub', code:'##CAIXA-ALTA##', note:'custom',
...
// ── 3gft artifact chest key rune stone energy ──────────────────────────────
  { date:'2026-##-##', type:'special', mission:'##', note:'untilLevel|2026-##-##T09:00:00Z|15',
    rewards:['artifact-chest-key x5', 'rune-stone x1500', 'energy x20'] },
// ── 3gft intelligence  strength  agility gift hub com data de validade ──────────────────────────────
{ date:'2026-##-##', type:'hub', code:'##CAIXA-ALTA##', note:'until|2026-##-##T01:00:00Z',
...
// ── yt 3gft youtube gift ──────────────────────────────
{ date:'2026-##-##', type:'special', mission:'#-#', note:'until|2026-##-##T05:00:00Z',
rewards:['boxys-gift x3', 'energy x100', 'realm-gift x3'] },

// ── 2gft seers orb energy ──────────────────────────────
{ date:'2026-##-##', type:'specialTask', mission:'##', note:'untilLevel|2026-##-##T01:00:00Z|15',
rewards:['seers-orb x50', 'energy x100'] },

// ── 2gft large skin stone energy ──────────────────────────────
{ date:'2026-##-##', type:'specialTask', mission:'##', note:'untilLevel|2026-##-##T01:00:00Z|15',
rewards:['large-skin-stone-chest x5', 'energy x100'] },

 // ── 2gft artifact chest key energy ──────────────────────────────
  { date:'2026-##-##', type:'specialTask', mission:'##', note:'untilLevel|2026-##-##T01:00:00Z|15',
    rewards:['artifact-chest-key x5', 'energy x100'] },

// ── 4gft + 5gft ──────────────────────────────
   { date:'2026-##-##', type:'special', mission:'#repeti#', note:'until|2026-##-##T01:00:00Z',
...
// ── 6gft  ──────────────────────────────
{ date:'2026-##-##', type:'special', mission:'##', note:'untilLevel|2026-##-##T01:00:00Z|15',
...
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   ...
   // ── June 10, 2026 ──────────────────────────────
   { date:'2026-06-11', type:'daily', mission:'3-11', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 10, 2026 ──────────────────────────────
   { date:'2026-06-10', type:'daily', mission:'2-12', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 9, 2026 ──────────────────────────────
   { date:'2026-06-09', type:'special', mission:'3-9', note:'until|2026-07-06T01:00:00Z',
    rewards:['adventure-coin x1000', 'energy x20', 'adventure-energy x50'] },
   { date:'2026-06-09', type:'daily', mission:'3-13', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 8, 2026 ──────────────────────────────
...
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
 ...
 rewards:['summoning-sphere x5', 'gold 250k', 'energy x20'] },
   { date:'2026-06-07', type:'daily', mission:'3-7', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June #, 2026 ──────────────────────────────
   { date:'2026-06-06', type:'daily', mission:'2-2', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 5, 2026 ──────────────────────────────
    { date:'2026-06-03', type:'hub', code:'ORMVIDEO', note:'until|2026-06-08T01:00:00Z',
rewards:['boxys-gift x3', 'energy x100', 'realm-gift x3'] },
   { date:'2026-06-05', type:'daily', mission:'3-14', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 4, 2026 ──────────────────────────────
   { date:'2026-06-04', type:'daily', mission:'2-7', note:'until|2026-06-07T05:00:00Z',
rewards:['boxys-gift x3', 'energy x100', 'realm-gift x3'] },
...
rewards:['energy x20', 'intelligence-skin-stone x350', 'strength-skin-stone x350', 'agility-skin-stone x350',] },
   ...
   { date:'2026-06-03', type:'daily', mission:'3-3', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 2, 2026 ──────────────────────────────
   { date:'2026-06-02', type:'daily', mission:'2-11', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── June 1, 2026 ──────────────────────────────
    { date:'2026-06-01', type:'special', mission:'2-9', note:'until|2026-06-08T01:00:00Z',
...
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   ...
   { date:'2026-05-28', type:'special', mission:'3-5', note:'until|2026-06-08T01:00:00Z',
    rewards:['adventure-coin x1000', 'energy x20', 'adventure-energy x50'] },
   { date:'2026-05-28', type:'daily', mission:'3-11', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
   // ── May 27, 2026 ──────────────────────────────
   { date:'2026-05-27', type:'daily', mission:'2-12', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
    // ── May 26, 2026 ──────────────────────────────
   // ──  6gft Realm ────────────────────────────── 
{ date:'2026-05-26', type:'special', mission:'2-13', note:'until|2026-06-08T01:00:00Z', rewards:['energy x20', '1h-construction-speedup x1', '1h-research-speedup X1', '1h-training-speedup x1', '1h-general-speedup x2', 'world-energy x30', ] },
   { date:'2026-05-26', type:'daily', mission:'3-13', note:'daily|80',
rewards:['silver-casket x1', 'energy x20', 'realm-casket x1'] },
    // ── May 25, 2026 ──────────────────────────────
