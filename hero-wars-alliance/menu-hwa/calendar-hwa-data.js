...
window.CALENDAR_MONTH_HEADER = {
  en: "Spring Storm Season Events",
  pt: "Eventos da Temporada Tempestades de Primavera",
  es: "Eventos de la Temporada Tormentas de Primavera",
  fr: "Événements de la Saison des Tempêtes de Printemps",
  de: "Ereignisse der Frühlingsturm-Saison",
  ja: "春の嵐シーズンイベント"
};
window.CALENDAR_DATA = [

  {
    ...
    alt: "Miu Guide",
  titles: {
  en: "Miu Legendary Skills Guide",
 de: "Leitfaden zu Mius legendären Fähigkeiten",
 es: "Guía de las Habilidades Legendarias de Miu",
 fr: "Guide des Compétences Légendaires de Miu",
 pt: "Guia das Habilidades Lendárias da Miu",
 ja: "美雨のレジェンダリースキルガイド"
},
...

{
    ...
    {// Dentro de extra[] de um evento:
 titles: { 
  en: "Golden Clover Treasure",
  pt: "Tesouro do Trevo Dourado",
  de: "Goldener Kleeschatz",
  es: "Tesoro del Trébol Dorado",
  fr: "Trésor du Trèfle Doré",
  ja: "黄金のクローバーの宝"
 },
 labelOnly: true
},
 ...
 labelOnly: true
  ...
  },
  {
    ...
    extra: [
      ...
      {// Dentro de extra[] de um evento:
 titles: { 
  en: "Path to Perfection Event",
  pt: "Evento Caminho para a Perfeição",
  de: "Event: Weg zur Perfektion",
  es: "Evento Camino a la Perfección",
  fr: "Événement Chemin vers la Perfection",
  ja: "完璧への道イベント"
 },
  labelOnly: true
},
 ...
 titles: { 
...

  {
    ...
    alt: "Way of Mystery Event",
        titles: { en: "Way of Mystery Event", de: "Event: Weg des Mysteriums", es: "Evento: Camino del Misterio", fr: "Événement : Chemin du Mystère", pt: "Evento Caminho do Mistério", ja: "ミステリーの道イベント" },
        links: { en: "../../hero-wars-alliance/event-hwa/way-of-mystery-event-en.html", de: "", es: "", fr: "", pt: "../../hero-wars-alliance/event-hwa/way-of-mystery-event-pt.html", ja: "" }, extra: [   
      {
        titles: { en: "Lian - Relic Event", de: "Lian - Relikt-Ereignis", es: "Lian - Evento de Reliquia", fr: "Lian - Événement des Reliques", pt: "Lian - Evento de Relíquia", ja: "リアン - レリックイベント" },
       ...
       {
       titles: { en: "Lian Guide", de: "Lian Leitfaden", es: "Lian - Guía", fr: "Lian - Guide", pt: "Guia - Lian", ja: "リアン - ガイド" },
       links: { en: "../../Hero Wars/Guia de Heróis Hero Wars/lian-herowars.html", de: "", es: "", fr: "", pt: "../../Hero Wars/Guia de Heróis Hero Wars/lian.html", ja: "" },       
       noStrip: true
      },  
    ]
  },
...
{// Dentro de extra[] de um evento:
  titles: { en: "Astral Reflections - Lian Skin+", pt: "Reflexões Astrais - Lian Skin+", de: "Astralische Reflexionen - Lian Skin+", es: "Reflejos Astrales - Lian Skin+", fr: "Réflexions Astrales - Lian Skin+", ja: "アストラルリフレクション - リアン スキン+" },
  labelOnly: true
}     
...
{// Dentro de extra[] de um evento:
  titles: { en: "Holiday Every Day - Gifts", pt: "Feriado Todos os Dias - Presentes", de: "Feiertag Jeden Tag - Geschenke", es: "Vacaciones Todos los Días - Regalos", fr: "Vacances Tous les Jours - Cadeaux", ja: "毎日が休日 - ギフト" },
  labelOnly: true
},     
