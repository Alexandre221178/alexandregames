...
window.CALENDAR_MONTH_HEADER = {
  ...
  pt: "Eventos da Temporada Espíritos Esmeralda",
  es: "Eventos de la Temporada Espíritus Esmeralda",
  fr: "Événements de la Saison des Esprits Émeraude",
  de: "Ereignisse der Smaragd-Geister-Saison",
  ja: "エメラルドスピリットシーズンイベント"
};
...

{
 ...
 titles: { en: "Umbra - Event", pt: "Umbra - Evento", de: "Umbra - Ereignis", es: "Umbra - Evento", fr: "Umbra - Événement", ja: "アンブラ - イベント" },
...

  {
    ...
    extra: [   
      {
        titles: { en: "Alvanor - Relic Event", de: "Alvanor - Relikt-Ereignis", es: "Alvanor - Evento de Reliquia", fr: "Alvanor - Événement des Reliques", pt: "Alvanor - Evento de Relíquia", ja: "アルヴァノール - レリックイベント" },
  ...
  
{
 titles: { en: "Mushy & Shroom Tribal Skin", pt: "Mushy & Shroom Tribal Skin", de: "Mushy & Shroom Tribal Skin", es: "Mushy & Shroom Tribal Skin", fr: "Mushy & Shroom Tribal Skin", ja: "マッシー＆シュルーム トライバル スキン" },
...

  {
    weekday: "Tuesday",
    date: "Mar, 10",
    image: "../../img-HWM/events-img/way-of-nature/wayofnature-150px.webp",
    alt: "Way of Nature",
  ...
  },
  {
    ...
    extra: [  
      {
        titles: { en: "Power of the Elements", de: "Wenn Welten Zusammenstoßen Ereignis", es: "Evento Cuando los Mundos Colisionan", fr: "Événement Quand les Mondes Entrent en Collision", pt: "Evento Quando os Mundos Colidem", ja: "世界が衝突するイベント" },
    links: { en: "../../Hero Wars/events/power-of-the-elements-event-en-hwa.html", de: "", es: "", fr: "", pt: "../../Hero Wars/events/power-of-the-elements-event-pt-hwa.html", ja: "" },
        },
        {
        titles: { en: "Oya - Relic Event", de: "Oya - Relikt-Ereignis", es: "Oya - Evento de Reliquia", fr: "Oya - Événement des Reliques", pt: "Oya - Evento de Relíquia", ja: "オヤ - レリックイベント" },
        links: { en: "../../hero-wars-alliance/event-hwa/relic-season-event-en.html", de: "", es: "", fr: "", pt: "../../hero-wars-alliance/event-hwa/relic-season-event-pt.html", ja: "" }
