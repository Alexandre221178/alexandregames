document.addEventListener("DOMContentLoaded", function () {
  ...
  <div class="button-container">
    <button id="accept-cookies" class="btn accept-btn">Aceptar todas</button>
    <button id="reject-cookies" class="btn reject-btn">Rechazar todas</button>
  </div>
  <a href="https://alexandregames.com/Documentos/PrivacyPolicy.html" class="privacy-link">Política de privacidad</a>
</div>
    `;
