...
extra: [
  ...
  {
  titles: {
  en: "☀️ Folio's New Solar Skin",

  pt: "☀️ Nova Skin Solar de Folio",

  de: "☀️ Neuer Solar-Skin für Folio",

  es: "☀️ Nueva skin solar de Folio",

  fr: "☀️ Nouveau skin solaire de Folio",
...
labelOnly: true
  ...
  {
  titles: {
  en: "👗 Byrna Ancient Skin: Full Unlock",

  pt: "👗 Skin Ancestral da Byrna: Desbloqueio Completo",

  de: "👗 Byrnas Antiker Skin: Vollständig freigeschaltet",

  es: "👗 Skin Ancestral de Byrna: Desbloqueo Completo",

  fr: "👗 Skin ancestral de Byrna : Déverrouillage complet",
...
titles: { en: "🏴‍☠️ Blackbeard's Legacy", de: "🏴‍☠️ Blackbeards Vermächtnis", es: "🏴‍☠️ El Legado de Barbanegra", fr: "🏴‍☠️ L'Héritage de Barbe Noire", pt: "🏴‍☠️ Legado do Barba Negra", ja: "🏴‍☠️ 黒ひげの遺産" },
  ...
  noStrip: true
      ...
      {
  titles: {
    en: "🏝️ Treasure Island - New Event",
    pt: "🏝️ Ilha do Tesouro - Novo Evento",
    de: "🏝️ Schatzinsel - Neues Event",
    es: "🏝️ Isla del Tesoro - Nuevo Evento",
    fr: "🏝️ Île au Trésor - Nouvel Événement",
    ja: "🏝️ トレジャーアイランド - 新イベント"
  },
  labelOnly: true,
},
{
  titles: {
    en: "🌙 Qing Mao's New Lunar Skin",

    pt: "🌙 Nova Skin Lunar de Qing Mao",

    de: "🌙 Neuer Lunar-Skin für Qing Mao",

    es: "🌙 Nueva skin lunar de Qing Mao",

    fr: "🌙 Nouveau skin lunaire de Qing Mao",
...
{
  titles: {
    en: "👗 Julius, Chabba, Krista & Iris Skins: Full Unlock",

    pt: "👗 Skins de Julius, Chabba, Krista e Iris: Desbloqueio Completo",

    de: "👗 Julius-, Chabba-, Krista- & Iris-Skins: Vollständig freigeschaltet",

    es: "👗 Skins de Julius, Chabba, Krista e Iris: Desbloqueo Completo",

    fr: "👗 Skins de Julius, Chabba, Krista et Iris : Déverrouillage complet",

    ja: "👗 ジュリアス、チャバ、クリスタ、アイリスのスキン：完全解放"
  },
  labelOnly: true,
},
...
// August 17 - Monday
  {
    ...
    extra: [
      ...
      {
  titles: {
    en: "Asherona New Champion Skin",

    pt: "Nova Skin Campeão de Asherona",

    de: "Asheronas neuer Champion-Skin",

    es: "Nueva skin de Campeón de Asherona",

    fr: "Nouvelle skin de Champion d'Asherona",
...
{
  titles: {
    en: "🤖 Iyari Mechanical Skin: Full Unlock",

    pt: "🤖 Skin Mecânica de Iyari: Desbloqueio Completo",

    de: "🤖 Iyaris Mechanischer Skin: Vollständig freigeschaltet",

    es: "🤖 Skin Mecánica de Iyari: Desbloqueo Completo",

    fr: "🤖 Skin mécanique d'Iyari : Déverrouillage complet",

    ja: "🤖 イヤリのメカニカルスキン：完全解放"
  },
  labelOnly: true,
},
{
     ...
     },
{
  ...
  // August 22 verificar subeventos (aqui pode começar novo evento de heroi ou titan
   {
    weekday: "Saturday",
    date: "August, 22",
