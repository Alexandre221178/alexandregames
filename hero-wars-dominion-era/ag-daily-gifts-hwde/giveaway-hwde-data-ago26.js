...
const giveawayData = {
  pt: {
    ...
    rewards: [
      ...
      { winner_id: "Vencedor 3 - 352415090", rewards: [
  ...
  en: {
    ...
    para2: "<p><b>📝 HOW TO PARTICIPATE:</b></p><ol><li>1️⃣ <strong>Open the video</strong> using the link below.</li><li>2️⃣ <strong>Post your ID</strong> in the video comments to validate your participation.</li><li>3️⃣ The giveaway takes place on <b>Wednesday, August 26!</b></li></ol>",
    para3: "<a href=\"https://youtu.be/sAG1Wn3Irr0\" target=\"_blank\" style=\"background-color: #f30808; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;\">Open Alecto and Valdur's video on YouTube</a>",
    para4: "",
    rewardsTitle: "MONTHLY GIVEAWAY REWARDS: ALEXANDRE GAMES CHANNEL",
    tableCaption: "Table: Main giveaway rewards and winner IDs",
    rewards: [
        { winner_id: "Winner 1 - 57196525", rewards: [
        { item: "Small Skin Stone Chest x500", image: "../../hero-wars-dominion-era/images/events/shared/small-skin-stone-chest.webp" }
      ] },
        { winner_id: "Winner 2 - 57252724", rewards: [
        ...
        { winner_id: "Winner 3 - 352415090", rewards: [
  ...
  de: {
    ...
    para2: "<p><b>📝 SO NIMMST DU TEIL:</b></p><ol><li>1️⃣ <strong>Öffne das Video</strong> über den untenstehenden Link.</li><li>2️⃣ <strong>Poste deine ID</strong> in den Kommentaren des Videos, um deine Teilnahme zu bestätigen.</li><li>3️⃣ Das Gewinnspiel findet am <b>Mittwoch, den 26. August, statt!</b></li></ol>",
    para3: "<a href=\"https://youtu.be/sAG1Wn3Irr0\" target=\"_blank\" style=\"background-color: #f30808; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;\">Video von Alecto und Valdur auf YouTube öffnen</a>",
    para4: "",
    ...
    rewards: [
        ...
        { winner_id: "Gewinner 3 - 352415090", rewards: [
  ...
  es: {
    ...
    para2: "<p><b>📝 CÓMO PARTICIPAR:</b></p><ol><li>1️⃣ <strong>Abre el video</strong> usando el enlace de abajo.</li><li>2️⃣ <strong>Publica tu ID</strong> en los comentarios del video para validar tu participación.</li><li>3️⃣ El sorteo se realizará el <b>miércoles 26 de agosto.</b></li></ol>",
    para3: "<a href=\"https://youtu.be/sAG1Wn3Irr0\" target=\"_blank\" style=\"background-color: #f30808; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;\">Ver el video de Alecto y Valdur en YouTube</a>",
    para4: "",
    ...
    rewards: [
        ...
        { winner_id: "Ganador 3 - 352415090", rewards: [
  ...
  fr: {
    ...
    para2: "<p><b>📝 COMMENT PARTICIPER :</b></p><ol><li>1️⃣ <strong>Ouvrez la vidéo</strong> via le lien ci-dessous.</li><li>2️⃣ <strong>Publiez votre ID</strong> dans les commentaires de la vidéo pour valider votre participation.</li><li>3️⃣ Le tirage au sort aura lieu le <b>mercredi 26 août !</b></li></ol>",
    para3: "<a href=\"https://youtu.be/sAG1Wn3Irr0\" target=\"_blank\" style=\"background-color: #f30808; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;\">Voir la vidéo d’Alecto et Valdur sur YouTube</a>",
    para4: "",
    ...
    rewards: [
        ...
        { winner_id: "Gagnant 3 - 352415090", rewards: [
  ...
  ja: {
    ...
    para2: "<p><b>📝 参加方法:</b></p><ol><li>1️⃣ <strong>下のリンクから動画を開く</strong></li><li>2️⃣ <strong>動画のコメント欄にあなたのIDを投稿</strong>して参加を有効にする</li><li>3️⃣ 抽選は<b>8月26日（水）</b>に行われます。</li></ol>",
    para3: "<a href=\"https://youtu.be/sAG1Wn3Irr0\" target=\"_blank\" style=\"background-color: #f30808; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;\">YouTubeでアレクトとヴァルダーの動画を見る</a>",
    para4: "",
    rewardsTitle: "月間ギブアウェイ報酬: ALEXANDRE GAMESチャンネル",
    tableCaption: "表: ギブアウェイの主な報酬と当選者ID",
    rewards: [
        { winner_id: "当選者1 - 57196525", rewards: [
        { item: "スモールスキンストーンチェスト x500", image: "../../hero-wars-dominion-era/images/events/shared/small-skin-stone-chest.webp" }
      ] },
        { winner_id: "当選者2 - 57252724", rewards: [
        ...
        { winner_id: "当選者3 - 352415090", rewards: [
