...
const giveawayData = {
  ...
  de: {
    ...
    para2: "<p><b>📝 SO NIMMST DU TEIL:</b></p><ol><li>1️⃣ <strong>Öffne das Video</strong> über den untenstehenden Link.</li><li>2️⃣ <strong>Poste deine ID</strong> in den Kommentaren des Videos, um deine Teilnahme zu bestätigen.</li><li>3️⃣ Das Gewinnspiel findet am <b>Mittwoch, den 23. September, statt!</b></li></ol>",
  ...
  es: {
    ...
    para2: "<p><b>📝 CÓMO PARTICIPAR:</b></p><ol><li>1️⃣ <strong>Abre el video</strong> usando el enlace de abajo.</li><li>2️⃣ <strong>Publica tu ID</strong> en los comentarios del video para validar tu participación.</li><li>3️⃣ El sorteo se realizará el <b>miércoles 23 de septiembre.</b></li></ol>",
  ...
  fr: {
    ...
    para2: "<p><b>📝 COMMENT PARTICIPER :</b></p><ol><li>1️⃣ <strong>Ouvrez la vidéo</strong> via le lien ci-dessous.</li><li>2️⃣ <strong>Publiez votre ID</strong> dans les commentaires de la vidéo pour valider votre participation.</li><li>3️⃣ Le tirage au sort aura lieu le <b>mercredi 23 septembre !</b></li></ol>",
  ...
  ja: {
    ...
    para2: "<p><b>📝 参加方法:</b></p><ol><li>1️⃣ <strong>下のリンクから動画を開く</strong></li><li>2️⃣ <strong>動画のコメント欄にあなたのIDを投稿</strong>して参加を有効にする</li><li>3️⃣ 抽選は<b>9月23日（水）</b>に行われます。</li></ol>",
