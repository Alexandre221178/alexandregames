...
const mysteriousIslandData = {
 pt: {
    title: "Ilha Misteriosa Abril, 2026 - Mapa 1",
    ...
    figcaption: "Mapa 1 da Ilha Misteriosa de Abril, 2026, Hero Wars: Dominion Era.",
    para3: "Este Mapa 1 de abril é ideal para jogadores que querem coletar Esmeraldas Grátis, infelizmente a Caixa de Bandeira de Guerra, esta precisando de muito movimentos nesse mapa, e a bandeira de guerra é item essencial para jogadores iniciantes, veja a tabela abaixo como garantir esses itens com baixo custo.",
...
// { item: "500 Esfera de Artefato Titã", cost: "+10", image: "../../hero-wars-dominion-era/images/events/shared/titan-artifact-sphere.webp" },
 //{ item: "50K Pedras de Skin de Titã", cost: "+15", image: "../../hero-wars-dominion-era/images/events/shared/titan-skin-stone.webp" },
  ...
  en: {
    title: "Mysterious Island April, 2026 - Map 1",
    para1: "The Mysterious Island of April 2026 brings fresh challenges and exciting rewards for all adventurers! This month's map features an optimized route that allows <b>F2P players</b> to efficiently collect <b>20,000 Free Emeralds</b> using 23 Explorer Moves plus 6 additional Explorer Moves to collect <b>100 Primal Catalyst</b>.",
    para2: "With strategic planning and careful use of your Explorer's Moves, you can navigate maze-like paths, unlock bridges by collecting wooden logs, and reach valuable reward towers. Whether you're aiming for the War Flag or focusing on seasonal resources, this guide will help you make the most of your journey across the Mysterious Island in April!",
    figcaption: "Mysterious Island April Map 1, 2026, Hero Wars: Dominion Era.",
    para3: "This April Map 1 is ideal for players who want to collect Free Emeralds; unfortunately the War Flag Chest requires many moves on this map, and the war flag is an essential item for new players — see the table below for how to secure these items at low cost.",
    rewardsTitle: "Mysterious Island Main Rewards - Alexandre Games Route",
  ...
  de: {
    title: "Mysterious Island April, 2026 - Karte 1",
    ...
    figcaption: "Mysterious Island April Karte 1, 2026, Hero Wars: Dominion Era.",
    para3: "Diese April-Karte 1 ist ideal für Spieler, die kostenlose Smaragde sammeln möchten; leider erfordert die Kriegsflaggen-Truhe auf dieser Karte viele Bewegungen, und die Kriegsflagge ist ein wichtiges Item für neue Spieler — siehe die Tabelle unten, um zu erfahren, wie man diese Gegenstände kostengünstig sichern kann.",
  ...
  es: {
    title: "Isla Misteriosa Abril, 2026 - Mapa 1",
  ...
  fr: {
    title: "Île Mystérieuse Avril, 2026 - Carte 1",
    ...
    figcaption: "Carte 1 de l'Île Mystérieuse d'Avril, 2026, Hero Wars: Dominion Era.",
    para3: "Cette Carte 1 d'avril est idéale pour les joueurs souhaitant collecter des Émeraudes Gratuites ; malheureusement, le Coffre de Drapeau de Guerre nécessite de nombreux mouvements sur cette carte, et la bannière de guerre est un objet essentiel pour les nouveaux joueurs — consultez le tableau ci-dessous pour savoir comment sécuriser ces objets à moindre coût.",
  ...
  ja: {
    ...
    figcaption: "謎の島 2026年4月 マップ1, Hero Wars: Dominion Era.",
    para3: "この4月のマップ1は、無料のエメラルドを集めたいプレイヤーに最適です。残念ながら、このマップでは戦争旗の宝箱を得るには多くの移動が必要であり、戦争旗は新規プレイヤーにとって重要なアイテムです — 下の表で低コストでこれらのアイテムを確保する方法を確認してください。",
